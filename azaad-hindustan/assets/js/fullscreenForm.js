	...
	(function (window) {
		...
		FForm.prototype._initEvents = function () {
			...
			/* add custom drag code here */

			$(".ui-widget-content").draggable({
				revert: true,

				drag: function () {
					$(".drager").addClass("is-active")
					$(".drager-text").addClass("is-active")
					$(".drager-text").html("drop it")
			...
			$("#droppable").droppable({
				...
				drop: function (event, ui) {
					...
					if (ui.draggable.find(".quiz-option").hasClass("correct-option")) { // correct option
						...
						$(".blast").addClass("show");
						$(".blast-inner").addClass("scale");
						$(".drag-panel").addClass("show");
						$(".drager").addClass("is-correct")
						$(".options-panel").addClass("hide");
						$(".next-btn").addClass('show');
						$(".drag-outer-box").removeClass('hvr-bob');
						$(".drager-container").addClass("overflow");
						setTimeout(function () {
							$(".drager-text").html("CORRECT")
						}, 10);

					}
					else{
					setTimeout(function () {
							$(".drager-text").html("WRONG")
						}, 10);	
			...
			$(".next-btn").click(function () {
				console.log($(".fs-current").index())
				$(".overlay").removeClass("show");
				$(".blast").removeClass("show");
				$(".blast-inner").removeClass("scale");
				...
				$(".drager-container").removeClass("overflow");
				
				if($(".fs-current").index()==-1)
					{
						$("#last-screen").show();
					...
					switch (input.tagName.toLowerCase()) {
						...
						case 'input':
							[].slice.call(fld.querySelectorAll('input[type="radio"]')).forEach(function (inp) {
								inp.addEventListener('change', function (ev) { /*self._nextField();*/ }); // removing the click functionality to add the drag functionality
							});
							break;
		...
		FForm.prototype._progress = function () {
			if (this.options.ctrlProgress) {
				...
				$(".show-date").css({
					"left": this.current * (100 / this.fieldsCount) + "%"
				});
				$(".map-overlay").css({
					"height": 100 - this.current * (100 / this.fieldsCount) + "%"
				});

				$(".drag-details ul li").eq(this.current - 1).addClass("show");
