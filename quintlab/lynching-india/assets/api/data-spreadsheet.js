...
"<li class='"+[data[0].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[0].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[0].Age,] +"</h3>"
...
+"<li class='"+[data[1].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[1].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[1].Age,] +"</h3>"
...
+"<li class='"+[data[2].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[2].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[2].Age,] +"</h3>"
...
+"<li class='"+[data[3].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[3].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[3].Age,] +"</h3>"
...
+"<li class='"+[data[4].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[4].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[4].Age,] +"</h3>"
...
+"<li class='"+[data[5].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[5].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[5].Age,] +"</h3>"
...
+"<li class='"+[data[6].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[6].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[6].Age,] +"</h3>"
...
+"<li class='"+[data[7].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[7].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[7].Age,] +"</h3>"
...
+"<li class='"+[data[8].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[8].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[8].Age,] +"</h3>"
...
+"<li class='"+[data[9].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[9].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[9].Age,] +"</h3>"
...
+"<li class='"+[data[10].Name,]+"'>"
	+ "<div class='contact-list'>"
		+ "<figure>"
			...
			+ "<figcaption>"
				+ "<h3 class='label-1'>" +[data[10].Name,] +"</h3>"
				+ "<h3 class='label-2'>" +[data[10].Age,] +"</h3>"
