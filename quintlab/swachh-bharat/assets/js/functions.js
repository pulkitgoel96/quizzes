...
$(document).ready(function() {
  ...
  sections.forEach(function(section) {
    $.getJSON('https://www.thequint.com/api/v1/stories?limit=1&section-id=' + section.id, function(res) {
...
$(document).ready(function() {
  ...
  $.getJSON('https://www.thequint.com/api/v1/collections/' + collectionSlug, function(res) {
    ...
    var elements = stories.map(function(story) {
      return '<div class="col col-2 more-list"><figure><a href="http://www.thequint.com/' + story.slug + '" target="blank"><img src="https://images.assettype.com/' + story['hero-image-s3-key'] + '?q=70&w=800&fm=pjpg" /><figcaption><span>' + story.headline + '</span></figcaption></a></figure></div>'
    });
    elements.forEach(function(element) {
